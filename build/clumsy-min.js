var game = {
    ...
    onload: function () {
        return me.video.init(900, 600, {
            ...
            scale: "auto",
            scaleMethod: "fit"
        }) ? (me.audio.init("m4a"), void me.loader.preload(game.resources, this.loaded.bind(this))) : void alert("Your browser does not support HTML5 canvas.")
    },
    loaded: function () {
...
/*me.ScreenObject.extend({
    ...
    onResetEvent: function () {
        ...
        this.dialog = new(me.Renderable.extend({
            init: function () {
                this._super(me.Renderable, "init", [0, 0, me.game.viewport.width / 2, me.game.viewport.height / 2]), this.font = new me.Font("gamefont", 40, "black", "left"), this.steps = "Punktee: " + game.data.steps.toString(), this.topSteps = "Highscore: " + me.save.topSteps.toString()
            },
            draw: function (a) {
